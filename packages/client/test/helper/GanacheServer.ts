...
export class GanacheServer {
    ...
    public static setTestLinkCollectionAddress(address: string) {
        LIVE_CONTRACTS.bosagora_devnet.LinkCollection = address;
        contextParamsLocalChain.linkCollectionAddress = address;
    }
